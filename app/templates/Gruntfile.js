  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      jscore: {
        ...
        dest: 'build/assets/js/application-core.js'
      },
      ...
      jsie: {
        ...
        dest: 'build/assets/js/application-ie.js'
      },
    ...
    uglify: {
      core: {
        src: ['build/assets/js/application-core.js'],
        dest: 'build/assets/js/application-core.min.js'
      },
      ie: {
        src: ['build/assets/js/application-ie.js'],
        dest: 'build/assets/js/application-ie.min.js'
      },
      modules: {
